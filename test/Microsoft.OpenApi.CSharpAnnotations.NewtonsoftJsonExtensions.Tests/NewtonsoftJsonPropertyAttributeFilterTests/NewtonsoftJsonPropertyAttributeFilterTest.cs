...
namespace Microsoft.OpenApi.CSharpAnnotations.NewtonsoftJsonExtensions.Tests.NewtonsoftJsonPropertyAttributeFilterTests
{
        ...
        public static IEnumerable<object[]> GetTestCasesForApplyFilterAndShouldReturnCorrectDocument()
        {
            ...
            yield return new object[]
            {
                ...
                new List<string>
                {
                    ...
                    Path.Combine(InputDirectory, "Contracts.xml")
                },
                new List<string>
                {
                    Path.Combine(
